    ...
    def _task_context_message(
        ...
        return {
            ...
            "content": (
                ...
                f"shell_requested: {'yes' if task_state.shell_requested else 'no'}\n"
                f"static_frontend: {'yes' if task_state.static_frontend else 'no'}\n"
                "For ordinary file edits, comments, reads, and content creation, "
                "do not use run_shell unless the user explicitly requests command "
